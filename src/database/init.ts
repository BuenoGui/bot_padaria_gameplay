...
import { comprar_gas, melhorar_gas, melhorar_geladeira, melhorar_vitrine, melhorar_forno } from "../services/loja_service.js";
...
async function init() {
    ...
    for (let i = 0; i <= 15000; i++) {
        const indexes_sorteado = sortInt(0, conjunto_acoes.length)
